...
[ "$V" != "1" ] && [ "$V" != "2" ] && [ "$V" != "3" ] || echo "1. testing all"
...
[ "$V" != "1" ] && [ "$V" != "2" ] && [ "$V" != "3" ] || echo "2. testing bonus"
...
[ "$V" != "1" ] && [ "$V" != "2" ] && [ "$V" != "3" ] || echo "3. testing default"
...
[ "$V" != "1" ] && [ "$V" != "2" ] && [ "$V" != "3" ] || echo "4. testing push_swap"
...
[ "$V" != "1" ] && [ "$V" != "2" ] && [ "$V" != "3" ] || echo "5. testing checker"
