...
int	main(void)
{
	...
	for (size_t i = 0; i <= COUNT; i++)
	{
		...
		printf("%5zu", table[i].txt_m.moves);
		printf("%5zu", table[i].txt_q.moves);
		printf("%5zu", table[i].tsb_m.moves);
		printf("%5zu", table[i].tsb_q.moves);
		printf("%5zu", table[i].txb_m.moves);
		printf("%5zu", table[i].txb_q.moves);
		...
		printf("%5zu", table[i].sxs_m.moves);
		printf("%5zu", table[i].sxs_q.moves);
		...
		printf("%5zu", table[i].bxt_m.moves);
		printf("%5zu", table[i].bxt_q.moves);
		printf("%5zu", table[i].bsb_m.moves);
		printf("%5zu", table[i].bsb_q.moves);
		printf("%5zu", table[i].bxb_m.moves);
		printf("%5zu", table[i].bxb_q.moves);
