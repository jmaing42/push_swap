...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ps_strategy_tot_quick_no_rotate_count.c            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: Juyeong Maing <jmaing@student.42seoul.kr>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/09 09:52:33 by Juyeong Maing     #+#    #+#             */
/*   Updated: 2022/07/09 10:16:18 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
)
{
	const t_ps_strategy_count_item	current
		= ps_strategy_util_try_all_permutations(
			table,
			index,
			ps_strategy_tot_quick_no_rotate_count);

	if (table[index].tot.item.moves > current.moves)
	{
		table[index].tot.item = current;
		table[index].tot.func = ps_strategy_tot_quick_no_rotate_execute;
		table[index].tot.name = "tot_quick_no_rotate";
	}
}
