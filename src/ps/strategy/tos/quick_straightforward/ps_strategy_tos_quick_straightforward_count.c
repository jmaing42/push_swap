...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ps_strategy_tos_quick_straightforward_count.c      :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: Juyeong Maing <jmaing@student.42seoul.kr>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/09 12:21:52 by Juyeong Maing     #+#    #+#             */
/*   Updated: 2022/07/09 12:32:01 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
)
{
	...
	const size_t	sort_z = table[z].bsb.item.moves;
...
)
{
	const t_ps_strategy_count_item	current
		= ps_strategy_util_try_all_permutations(
			table,
			index,
			ps_strategy_tos_quick_straightforward_count);

	if (table[index].tos.item.moves > current.moves)
	{
		table[index].tos.item = current;
		table[index].tos.func = ps_strategy_tos_quick_straightforward_execute;
		table[index].tos.name = "tos_quick_straightforward";
	}
}
