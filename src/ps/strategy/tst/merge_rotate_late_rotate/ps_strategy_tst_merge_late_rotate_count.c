...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ps_strategy_tst_merge_late_rotate_count.c          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: Juyeong Maing <jmaing@student.42seoul.kr>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/02 13:42:58 by Juyeong Maing     #+#    #+#             */
/*   Updated: 2022/07/08 21:06:55 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
)
{
	...
	if (table[index].tst.item.moves > current.moves)
	{
		...
		table[index].tst.func = ps_strategy_tst_merge_late_rotate_execute;
		table[index].tst.name = "tst_merge_late_rotate";
	}
}
