...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ps_strategy_bake_one.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: Juyeong Maing <jmaing@student.42seoul.kr>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/03 20:15:11 by Juyeong Maing     #+#    #+#             */
/*   Updated: 2022/07/03 20:53:57 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ps_strategy_bake_one_part1(
	t_ps_strategy_count *table,
	size_t count
)
{
...
static void	ps_strategy_bake_one_part2(
	t_ps_strategy_count *table,
	size_t count
)
{
...
static void	ps_strategy_bake_one_part3(
	t_ps_strategy_count *table,
	size_t count
)
{
...
void	ps_strategy_bake_one(
	t_ps_strategy_count *table,
	size_t count
)
{
	ps_strategy_bake_one_part1(table, count);
	ps_strategy_bake_one_part2(table, count);
	ps_strategy_bake_one_part3(table, count);
	ps_strategy_bake_one_part4(table, count);
}
