...
size_t	ps_solve_tsb_quick_no_rotate_count(
	const t_ps_solve_table *t_ps_solve_table,
	size_t x,
	size_t y,
	size_t z
)
{
	return (
		...
		+ ps_solve_util_count_bsb(t_ps_solve_table, x)
		+ ps_solve_util_count_bob(t_ps_solve_table, y)
		+ ps_solve_util_count_tob(t_ps_solve_table, z)
	);
}
