...
/*   Updated: 2022/07/30 22:14:01 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_ps_stream							*stream;
	const t_ps_solve_util_const_array	*p;
	const t_ps_solve_util_const_array	*q;
	const t_ps_solve_util_const_array	*r;
	const int							*array;
	bool								from_right;
