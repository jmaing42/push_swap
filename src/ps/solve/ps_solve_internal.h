...
t_err							ps_solve_util_collect_to_top_stb(
									const t_ps_solve_context *context,
									const t_ps_solve_util_parts_collect *parts,
									bool from_right);
...
t_err							ps_solve_util_divide_from_top_stb(
									const t_ps_solve_context *context,
									const t_ps_solve_util_parts_divide *parts,
									const int *array,
									bool from_right);
...
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_stb(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_sbt(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_tsb(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_tbs(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_bst(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
t_ps_solve_util_parts_divide	*ps_solve_util_allocate_divide_bts(
									const int *array,
									size_t big,
									size_t medium,
									size_t small);
