...
/*   Updated: 2022/05/19 02:31:46 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
)
{
	...
	result->values[self->size_left] = self->values[self->size_left + 1];
	result->values[self->size_left + 1] = self->values[self->size_left];
	return (result);
}
