...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   push_swap_operations_reverse.c                     :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: Juyeong Maing <jmaing@student.42seoul.kr>  +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/20 01:34:05 by Juyeong Maing     #+#    #+#             */
/*   Updated: 2022/05/20 02:27:35 by Juyeong Maing    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static uint8_t	reverse_order(uint8_t operation)
{
...
static uint8_t	reverse_rtl(uint8_t operation)
{
	if (operation == PUSH_SWAP_OPERATION_SA)
		return (PUSH_SWAP_OPERATION_SB);
	if (operation == PUSH_SWAP_OPERATION_SB)
...
)
{
	...
	while (i < self->length)
	{
		result->operation[i] = reverse_order(self->operation[i]);
		i++;
	}
...
)
{
	...
	while (i < self->length)
	{
		result->operation[i] = reverse_rtl(self->operation[i]);
		i++;
	}
	result->length = self->length;
	return (result);
...
)
{
	...
	{
		result->operation[i]
			= reverse_rtl(reverse_order(self->operation[self->length - i - 1]));
		i++;
	}
	result->length = self->length;
	return (result);
