...
#ifndef FT_TYPEDEF_POINTER_H

typedef void								*t_vp;
typedef char								*t_cp;
typedef float								*t_sfp;
typedef double								*t_sdp;
...
typedef const signed long long				*t_csllp;
...
typedef volatile char						*t_vcp;
typedef volatile float						*t_vsfp;
typedef volatile double						*t_vsdp;
...
typedef const volatile char					*t_cvcp;
typedef const volatile float				*t_cvsfp;
typedef const volatile double				*t_cvsdp;
